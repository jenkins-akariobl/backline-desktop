  ...
  gulp.task 'build:' + platform, ->
    ...
    gulp.src './src/**'
      .pipe $.nodeWebkitBuilder
        ...
        macZip: true
        macPlist:
          NSHumanReadableCopyright: 'drfirst.com'
          CFBundleIdentifier: 'com.drfirst.backline'
      .on 'end', ->
        if process.argv.indexOf('--toolbar') > 0
...
gulp.task 'run:osx64', ['build:osx64'], ->
  shelljs.exec 'open ./build/Backline/osx64/Backline.app'
